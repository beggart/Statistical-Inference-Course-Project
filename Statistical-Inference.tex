...
\hypersetup{
  pdftitle={Peer-graded Assignment: Statistical Inference Course Project},
  pdfauthor={Benjamin Eggart},
  hidelinks,
...
\includegraphics{Statistical-Inference_files/figure-latex/unnamed-chunk-9-1.pdf}
